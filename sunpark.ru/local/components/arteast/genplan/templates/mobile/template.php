		...
		<div class="plans">
			<div class="pHouses" style="z-index:3">
				<div class="plan" data-id="1" style="z-index:100;">
					<img class="img" src="/local/img/map_1mobn.jpg" alt="" />
...
<?php endif ?>
		...
		<div class="plans">
			<div class="pHouses" <?= $houseId ? 'style="display:none;"' : '' ?> style="z-index:3">
				...
				<div class="plan" data-id="2" style="z-index:99;">
					<img class="img" src="/local/img/map_2mob.jpg" alt="" />
					<?php foreach($gens as $gen): ?>
				...
				<div style="z-index:98;">
					<img data-id="0" src="/local/img/map_blank_mob.png" style="display:block!important;" alt="" />
				</div>
				<div class="buts" style="z-index:101; display:none;">
	...
	<div class="revers-btn-wrap">
		<span class="genplan-revers-btn" onclick="apart.Reverse()"><span>С другого ракурса</span> <img src="/local/img/reverse_green.png" alt="" /></span>
	</div>
	<?php endif ?>
</div>
